...
public class MainController {
	...
	public String registerUserAccount(@ModelAttribute("user") User userDto, BindingResult result, Model model) {
		...
		UserDetails uexist = userService.loadUserByUsername(userDto.getUsername());
		String username = uexist.getUsername();

		if (existing != null || uexist != null) {
		 ...
		 * 
		 * if (uexist != null) { model.addAttribute("existingusername", username);
